...
Loop
		...
		btg PORTA,RA3 			;Toggle pin 3 of reg A
		btg PORTC,RC3          ;Toggle pin 3 of reg C
...
Initial
		...
		MOVLF  B'00000010',ALIVECNT ;ADDED by AC
return
