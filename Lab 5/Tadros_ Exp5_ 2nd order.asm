...
SampleSum
				...
				addwf value1, WREG ; x[n-2]
				addwf value3, WREG ; x[n] or the new sample added to the buffer
...
bufferUpdate
			...
			label_E
				...
				movf value2, W
				movwf value1		; value1 is the new x[n-2]
				...
				;value3 of new buffering is the new sample added (denoated by variable value)
				movf value, W
				movwf value3     ; value3 is the new x[n]
