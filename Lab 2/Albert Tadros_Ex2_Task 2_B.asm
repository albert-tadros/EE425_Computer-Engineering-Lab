;;;;;;; P0 template AC and Albert Tadros;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
...
Loop
		bsf PORTC, RC3			;set bit 3 of reg C
		bsf PORTA, RA3			;set bit 3 of reg A
...
Initial
		...
		MOVLF  B'00000111',ALIVECNT ; intial value of 7
...
;;;;;;;;;;;;;;; setLow Subroutine;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; This subroutine creates the low signals and maintains their time by using LoopTime delay
...
;;;;;;;;;;;;;;; whenZero subroutine;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; This subroutine reinitialize the iterative variable for the next loop iterations and calls Loop

whenZero
	    MOVLF  7,ALIVECNT     ;Reinitialize BLNKCNT
        rcall Loop
return

;;;;;;;;;;;;;;;;;; BAend subroutine;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; This subroutine controls the high states of the signal
; it controls their time by using LoopTime delays 
...
BlinkAlive
		...
		MOVLF  B'00000011',WREG ; storing the value 3 in wreg to compare with value in ALIVECNT
        decf  ALIVECNT,F        ;Decrement loop counter and return if not zero
		bz whenZero				; if Z = True, branch to whenZero subroutine
		cpfsgt ALIVECNT			; if value of ALIVECNT > value of WREG, skip next instruction
		rcall setLow            ; call setLow subroutine to clear the bits
		bra BAend				;  if Z = false, branch to BAend subroutine
end