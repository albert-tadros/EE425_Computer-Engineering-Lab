...
Loop
		...
		bsf PORTC, RC3			; set bit 3 of reg C to high 
		bsf PORTA, RA3			; set bit 3 of reg A to high 
...
BlinkAlive
		bcf PORTC, RC3			; clear bit 3 of reg C
		bcf PORTA, RA3			; clear bit 3 of reg A
		
        decf  ALIVECNT,F        ;Decrement loop counter and return if not zero
        bnz  BAend				; if Z flag is false, branch to BAend
...
BAend
		...
		rcall BlinkAlive		; call BlinkAlive 
