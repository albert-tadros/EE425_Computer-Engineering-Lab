...
SampleSum
				...
				addwf value1, WREG ; x[n-1]
				addwf value2, WREG ; x[n] or the new sample added to the buffer
				movwf dividedSum			; move content of WREG into dividedSum
...
bufferUpdate
				...
				movf value, WREG 
				movwf value1 		; here value1 = first sample in SimpleTable
				bra exit
			...
			label_C
				...
				bra label_D
				movf value, WREG
				movwf value2 		; here value2 = second sample in SimpleTable
				rcall SampleSum
				bra exit
			
			label_D	
				; entire buffer has been intialized
				;updating the buffer when a new sample is added.

				;move value2 of previous buffering into value1 of new buffering
				movf value2, W
				movwf value1		; value1 is the new x[n-1]
				
	
				;value2 of new buffering is the new sample added (denoated by variable value)
				movf value, W
				movwf value2     ; value2 is the new x[n]
