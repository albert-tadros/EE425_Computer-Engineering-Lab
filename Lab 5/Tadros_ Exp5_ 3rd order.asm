...
;;;;;;; Variables ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
		...
		value5 ; fifth memory location in the buffer
		value6 ; sixth memory location in the buffer
...
SampleSum
				...
				addwf value1, WREG ; x[n-5]
				addwf value6, WREG ; x[n] or the new sample added to the buffer
...
bufferUpdate
			...
			label_F
				...
				MOVLF 6, SMPLCNT ;  SMPLCNT = 6, fifth sample to be read in initial buffer
				movf counter, WREG 
			...
			label_G
				...
				MOVLF 5, SMPLCNT ;  SMPLCNT = 5, sixth sample to be read in initial buffer
				movf counter, WREG 
			...
			label_H
				...
				movf value2, W
				movwf value1		; value1 is the new x[n-5]
				...
				;move value5 of previous buffering into value4 of new buffering
				movf value5, W
				movwf value4
		
				;move value6 of previous buffering into value5 of new buffering
				movf value6, W
				movwf value5

				;value6 of new buffering is the new sample added (denoated by variable value)
				movf value, W
				movwf value6     ; value6 is the new x[n]
