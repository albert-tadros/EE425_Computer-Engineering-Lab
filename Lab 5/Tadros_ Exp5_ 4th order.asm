...
SampleSum
				...
				addwf value1, WREG ; x[n-4]
				addwf value5, WREG ; x[n] or the new sample added to the buffer
...
bufferUpdate
			...
			label_G
				...
				movf value2, W
				movwf value1		; value1 is the new x[n-4]
				...
				;value5 of new buffering is the new sample added (denoated by variable value)
				movf value, W
				movwf value5     ; value5 is the new x[n]
